...
<div id="mainContent">
						  <div class="accordion">
            <h3>CONTRAPTION</h3>
            <p>While INCEPTION led you to the world of “chain of thoughts”; here we are bringing to you CONTRAPTION- “the chain of energy-driven operations”......
“The mother of all events is back”
Simplest yet fascinating, most awaited event of the year. So, gear up for CONTRAPTION wherein you will be judged based on your innovation, creativity, compactness and of course craziness! 

            </p>
            <h3>ROBO HUSTLE</h3>
              <p>Here, the robots will Battle with each other to win over each other’s territory by planting bombs and mines in each other’s territory. The Robots can use the Pick n Place mechanism to plant bombs and mines in each other’s territory.
            </p>
             <h3>Technical Quiz</h3>
              <p> The quiz will be based on the questions related with electrical engineering. 
            </p>
             <h3>TECHNICAL PROJECT PRESENTATION</h3>
              <p>  “A project is complete when it starts working for you, rather than you working for it...”

Dexters and strivers for innovation; who certainly deserve appreciation; here is a chance for you to show cast your technicalities. 
“Imagination is more important than knowledge…”
 

            </p>
             <h3>E-Hunt</h3>	
              <p> “It’s not about speed, it’s about brains.”
It's a little bit of everything under one roof it's an experience, it's a treasure hunt.

 

            </p>
             <h3>Seminars</h3>
            <p>your long description goes here</p>
            <h3>Workshops</h3>
            <p><b>“Solar Photovoltaic Systems, Fundamentals Technology & Applications”</b>
...
<p>&nbsp;</p></td>
              ...
              <div class="navigation" id="nav">
                ...
                <div class="item home">
                    ...
                    <h2>tech details</h2>
                    <ul>
                             <li><a href="cryptonex.php">Cryptonex</a></li>
                        <li><a href="electroarena.php">Electro Arena</a></li>
                        <li><a href="elektrisch.php">Elektrisch</a></li>
