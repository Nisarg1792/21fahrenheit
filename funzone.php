...
<div id="mainContent">
						  <div class="accordion">
            <h3>MAHRAJA - THE CONQURER</h3>
            <p>Deriving the part of its concept from the famous ‘GAME OF THRONES’ , it is an event which testifies the skills required for being a successful person who can convert his/her thoughts into actions.
            </p>
            <h3>Gaming fiesta</h3>
            <p>Yes, the hot favourite on this platform where hot bloods of racers, combat warriors and sports persons are to be welcome.</p>
