...
<div id="mainContent">
           ...
           Select your evnts  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <?php echo (!empty($_SESSION['member'])) ? '<a href="logout.php"><font color="blue"><b>Logout</b></font></a>' : ''; ?>
           <br /><br />
           
           
           
           <form name="myForm" id="selection" action="admin/selectioninsert.php" method="post" onsubmit="return submit_button()">
      
       User ID :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="uname" size="20" /><br /><br />
      Password : <input type="password" name="pass1" size="20" /><br /><br />
           ...
           <select class="" id="event1" name="event1" aria-required="true">
                    <option value="aa">aa</option>
                    <option value="bb">bb</option>
                    <option value="cc">cc</option>
           </select>         
           <br /><br />
           <select class="" id="event2" name="event2" aria-required="true">
                    <option value=""   >Selection one</option>
                    <option value="b"   >b</option>
                    <option value="c"   >c</option>
           </select>         <br /><br />
           <select class="" id="event3" name="event3" aria-required="true">
                    <option value=""   >selection one</option>
                    <option value="2"   >2</option>
                    <option value="3"   >3</option>
           </select>         <br /><br />
           <select class="" id="event4" name="event4" aria-required="true">
                    <option value=""   >selection one</option>
