...
<div id="mainContent">
            ...
            <p>Ready get set go . Prepare yourself for the amazing race, where you will be tetsted for your knowledge, your strength,ypur decision which will lead your chances to win.</p>
            <h3>MA-3-X </h3>
            <p>MA-3-X is event which is purely based on logic and mathematics. All rounds are designed in such a way so that each round wii force you to use your brain and scratch your head.
            </p>
            <h3>Mad ad</h3>
            <p>Have you ever seen yourself organizing advertisement poured with creativity? If don’t !! this is the time to surprise the pavilion attracting the maximum to your brand. 3 steps and you will become the popular AD creator.
            </p>
            <h3>Neuron Twisterz </h3>
            <p>The following event aims at testing the knowledge and awareness of an individual in various fields. <br />Are you ready to check yours...??
            </p>
